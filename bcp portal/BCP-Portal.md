...
> # ***Security:***  #      
-  <span style="color:Black"> **User** </span>  login in user name , mobile number ,  email , login and logout , costem id and project id details and List.
-  <span style="color:black"> **Role Master** </span> customerid ,  rolr id , module id , role description_EN , role description_AR details.
- <span style="color:Black"> **User Activity** </span>   user activity  user name , server other detalis in user activity details.
- # Api:
...
>  [ **Coperate Api** ](./bcp%20portal.postman_collection.pdf)
